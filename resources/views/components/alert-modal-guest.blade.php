<div class="modal fade" id="userAlertModal" tabindex="-1" role="dialog" aria-hidden="true" style="padding-top: 10%">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body text-center p-5">
                ...
                <button type="button" class="btn btn-{{ $status }}" id="alertModalCloseButton" data-dismiss="modal">Đóng</button>
