        ...
        <div class="modal-content">
            <div class="modal-body text-center p-5">
                <div class="mb-4 text-center">
                    ...
                    @elseif($status === 'info')
                        <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="#17a2b8"
                ...
                <button type="button" class="btn btn-{{ $status }}" id="alertModalCloseButton"
        ...
        const modalHtml = `
            <div class="modal fade" id="alertModal" tabindex="-1" aria-labelledby="alertModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-body text-center p-5">
                            <div class="mb-4" style="display: flex;justify-content: center;text-align: center !important;">
                                ${status === 'success' ? 
